...
#nbVertices=[40,60,100]
#nbAtt=[2,3]
#minVertices=[100,80,60]

timeout=10000


mainFolder="siasPerfFlights"
...
def variateMinVertices():
    ...
    for minV in minVertices:
        ...
        createFolder(curFolder)
        designPoint=createDesignPoint(curFolder,mainFolder+"/input/default/322V14att/graph.json")
